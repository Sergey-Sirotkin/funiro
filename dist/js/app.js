(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main-slider__slider-body")) new core(".main-slider__slider-body", {
        ...
        if (document.querySelector(".rooms-slider__slider")) new core(".rooms-slider__slider", {
            modules: [ Navigation, Pagination, Parallax ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
            ...
            navigation: {
                prevEl: ".rooms .slider-arrow_prev",
                nextEl: ".rooms .slider-arrow_next"
            },
            on: {}
        });
        if (document.querySelector(".tips__slider")) new core(".tips__slider", {
            ...
            navigation: {
                prevEl: ".tips .slider-arrow_prev",
                nextEl: ".tips .slider-arrow_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.1,
...
***************************************************************************** */
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            ...
            if (!targetElement.closest(".search-form") && document.querySelector(".search-form.active")) document.querySelector(".search-form").classList.remove("active");
            ...
            if (targetElement.classList.contains("cart-header__icon") || targetElement.closest(".cart-header__icon")) {
                if (document.querySelector(".cart-list").children.length > 0) document.querySelector(".cart-header").classList.toggle("active");
                e.preventDefault();
            } else if (!targetElement.closest(".cart-header") && !targetElement.classList.contains("products-item__actions-btn")) document.querySelector(".cart-header").classList.remove("active");
        ...
        const callback = function(entries, observer) {
            if (entries[0].isIntersecting) headerElement.classList.remove("scroll"); else headerElement.classList.add("scroll");
        };
